...
class CKFinder_Connector_Core_FolderHandler
{
	 ...
	 * @return string
	 */
	public function getThumbsServerPath($dir = null)
	{
		if (is_null($this->_thumbsServerPath) || !is_null($dir))
		{
			$this->_resourceTypeConfig = $this->getResourceTypeConfig();
			...
			if (!is_null($dir))
			{
				$this->_thumbsServerPath = CKFinder_Connector_Utils_FileSystem::combinePaths($dir, $this->_resourceTypeConfig->getName());
			}
			else
			{
