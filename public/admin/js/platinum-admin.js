$(function(){
	...
	$('ul.imageList li').hover(
		function() {
			$(this).find('ul').css('display', 'none').slideDown('fast').css('display', 'block');
		},
		function() {
	...
	$("#message-link").click(function() {
		$('#messages-box').modal({
			...
			containerCss : {
				position: 'absolute'
			} //iþe yaramýyor, fixed ile eziliyor!
		});
	});
